...
from utils.product_service import buscar_produtos_ativos_db, inativar_produto_db, atualizar_produto_db
...
class ListProd(ctk.CTkFrame):
    ...
    def carregar_produtos_bd(self):
        ...
        produtos_reais = buscar_produtos_ativos_db(termo_busca)
